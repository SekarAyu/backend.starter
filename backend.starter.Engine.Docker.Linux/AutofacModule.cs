...
using QSI.Security.Authentication.Provider;
using System;
using System.Linq;
using System.Reflection;

namespace backend.starter.Engine.Docker.Linux
{
    /// <summary>
    ...
    public class AutofacModule : Autofac.Module
    {
        ...
        protected override void Load(ContainerBuilder builder)
        {
            ...
            Assembly[] assemblies = new Assembly[]
            {
                ...
                Assembly.Load("backend.starter.Service"),
                Assembly.Load("backend.starter.Repository.NHibernate"),
                Assembly.Load("backend.starter.Repository"),
            };
